  ...
  return (
    <div className="m-auto w-full">
      ...
      <div className="m-auto w-full bg-[#eef9f3] pt-7">
        ...
        <div className="px-5 py-5 m-auto max-w-360">
          <Grid gutter="lg">
            <GridCol span={{ base: 12, sm: 6, md: 4, lg: 4 }}>
              <LinkCard
                ...
                link="https://www.epicentro.iss.it/migranti/numeri-italia"
            ...
            <GridCol span={{ base: 12, sm: 6, md: 4, lg: 4 }}>
              <LinkCard
                ...
                link="http://www.epiprev.it/pubblicazione/epidemiol-prev-2017-41-3-
4-suppl-1"
